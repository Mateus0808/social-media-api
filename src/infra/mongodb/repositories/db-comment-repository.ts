import { LoadCommentsRepositoryInterface, LoadCommentsRepositoryParams, LoadCommentsRepositoryResponse } from './../../../application/ports/repositories/comment/load-comments-repository-interface';
