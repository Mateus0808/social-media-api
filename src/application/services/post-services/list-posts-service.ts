...
import { ListPostsServiceInterface, ListPostServiceParams, ListPostsServiceResponse } from '../../interfaces/post-interface/list-post-service-interface';
...
export class ListPostsService implements ListPostsServiceInterface {
  ...
  public async listPosts (listPostServiceParams: ListPostServiceParams): Promise<ListPostsServiceResponse> {
