...
import { UpdateCommentRepositoryInterface } from '../../../ports/repositories/post/comment/update-comment-repository-interface'
import {
  UpdateCommentServiceInterface,
  UpdateCommentServiceParams,
  UpdateCommentServiceResponse,
} from '../../../interfaces/post-interface/comment-interface/update-comment-service-interface'
